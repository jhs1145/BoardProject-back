...
public class BoardListResponseDto {
    ...
    private BoardListResponseDto(BoardListResultSet resultSet){
        ...
        this.writerNickname = resultSet.getWrtierNickname();
    }

    private BoardListResponseDto(BoardViewEntity boardViewEntity){
